...
export const nonprofitsSlice = createSlice({
  ...
  reducers: {
    ...
    nonprofitsReceived(state, action: PayloadAction<{ nonprofits: Nonprofit[] }>) {
      state.loading = false;
...
export const { nonprofitAdded, nonprofitRemoved, nonprofitsReceived } = nonprofitsSlice.actions;
